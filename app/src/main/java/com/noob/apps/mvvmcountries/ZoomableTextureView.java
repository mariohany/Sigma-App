...
public class ZoomableTextureView extends TextureView {
    ...
    private HandlePlayerControllerListener listener;
    ...
    public void setOnZoomableClickListener(HandlePlayerControllerListener listener){
    ...
    private void initView(AttributeSet attrs) {
        ...
        setOnTouchListener(new ZoomableTextureView.ZoomOnTouchListeners());
    }
    ...
    private class ZoomOnTouchListeners implements View.OnTouchListener {
        public ZoomOnTouchListeners() {
            super();
            m = new float[9];
            mScaleDetector = new ScaleGestureDetector(context, new ZoomableTextureView.ZoomOnTouchListeners.ScaleListener());
        }
